// source: https://domisto.com.ua/
// extracted: 2026-05-07T21:21:12.121Z
// scripts: 2

// === script #1 (length=1860) ===
document.addEventListener("DOMContentLoaded", function () {
  const currentUrl = window.location.pathname;
  if (currentUrl === "/") { // только главная
    // Определяем язык страницы
    const htmlLang = document.documentElement.lang || "ru";
    const titles = {
      ru: 'Производство мебели на фабрике "Феникс мебель" – качество и надежность',
      uk: 'Виробництво меблів на фабриці "Фенікс меблі" – якість та надійність'
    };
    const blockTitle = titles[htmlLang] || titles.ru;
    ...
    section.innerHTML = `
      <div style="padding:50px 0; background:#fafafa;">
        <div style="max-width:1100px; margin:0 auto; text-align:center;">
          <h2 style="font-size:30px; font-weight:bold; margin-bottom:30px; color:#222;">
            ${blockTitle}
          </h2>
          <div class="responsive-video-container">
            <iframe 
              src="https://www.youtube.com/embed/jClwKvG4fu8?rel=0" 
