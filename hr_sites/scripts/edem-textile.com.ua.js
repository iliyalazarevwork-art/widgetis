// source: https://edem-textile.com.ua/
// extracted: 2026-05-07T21:18:53.518Z
// scripts: 2

// === script #1 (length=756) ===
if (window.location.pathname.indexOf('/ru') === 0 ) {
          (function(d, w, s) {
	var widgetHash = '3gxpwk310mbq8xj5ddaf', gcw = d.createElement(s); gcw.type = 'text/javascript'; gcw.async = true;
	...
	var sn = d.getElementsByTagName(s)[0]; sn.parentNode.insertBefore(gcw, sn);
     ...
     {
          (function(d, w, s) {
	var widgetHash = '158iha445lxh51s2elpq', gcw = d.createElement(s); gcw.type = 'text/javascript'; gcw.async = true;
	gcw.src = '//widgets.binotel.com/getcall/widgets/'+ widgetHash +'.js';
	var sn = d.getElementsByTagName(s)[0]; sn.parentNode.insertBefore(gcw, sn);
  })(document, window, 'script');
    }
