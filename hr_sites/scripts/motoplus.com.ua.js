// source: https://motoplus.com.ua/
// extracted: 2026-05-07T21:19:07.249Z
// scripts: 1

// === script #1 (length=2018) ===
...
$(function () {
  ...
  if ($('.product-order').length > 0 && !$('#credit-paylater').length) {
    // Вставляємо кнопку "Плати пізніше" після блоку "Купити"
    $('.product-order__block--buy').after(
      '<div id="credit-paylater">   В кредит   </div>'
    );
  }
  ...
  $(document).on("click", "#credit-paylater", function () {
    ...
    if (typeof buyInCredit === 'function') {
	  let customerEmail = 'stoyanov.k.g@gmail.com'; // TODO: замінити на реальний email
