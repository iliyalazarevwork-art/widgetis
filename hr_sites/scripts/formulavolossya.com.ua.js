// source: https://formulavolossya.com.ua/
// extracted: 2026-05-07T21:21:25.386Z
// scripts: 1

// === script #1 (length=1965) ===
document.addEventListener("DOMContentLoaded", function () {
  ...
  function updateMessage() {
    ...
    if (total >= FREE_SHIPPING_FROM) {
      ...
      messageBlock.innerHTML = '<a href="https://formulavolossya.com.ua/" style="color:#2e7d32; text-decoration:none;">🛒 Додайте ще товарів на <b>' + left + ' грн</b> до безкоштовної доставки 🚀</a>';
    }
  }
