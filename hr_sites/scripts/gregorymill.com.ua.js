// source: https://gregorymill.com.ua/
// extracted: 2026-05-07T21:19:49.547Z
// scripts: 2

// === script #1 (length=13266) ===
class Utils {
    ...
    static log({
        ...
        if (tgLogEnabled) {
            let message_view = icon + ' <b>' + appname + ':</b> ' + message
            TelegramBot.sendLog({
    ...
    static get marketing_systems() {
        return {
            ...
            systems: [
                {
                    name: 'cookieutils',
                    src: 'https://external.hillary.ua/gregorymill.com.ua/cookieutils.js',
                    enabled: true,
                },
                {
                    name: 'telegrambot',
                    src: 'https://external.hillary.ua/gregorymill.com.ua/telegrambot.js',
                    enabled: true,
                },
                {
                    name: 'sitedebug.css',
                    src: 'https://external.hillary.ua/gregorymill.com.ua/sitedebug.css',
                    enabled: false,
                },
                {
                    name: 'style.css',
                    src: 'https://external.hillary.ua/gregorymill.com.ua/style.css',
                    enabled: false,
                },
                {
                    name: 'sitedebug',
                    src: 'https://external.hillary.ua/gregorymill.com.ua/sitedebug.js',
                    enabled: false,
                },
                {
                    name: 'lcw',
                    src: 'https://external.hillary.ua/gregorymill.com.ua/hyperlcw.js',
                    enabled: true,
                },
                {
                    name: 'esputnik',
                    src: 'https://external.hillary.ua/gregorymill.com.ua/esputnik.js',
                    enabled: false,
                },
                {
                    name: 'tiktok',
                    src: 'https://external.hillary.ua/gregorymill.com.ua/tiktok.js',
                    enabled: false,
                },
                {
                    name: 'esputnikEvents',
                    src: 'https://external.hillary.ua/gregorymill.com.ua/esputnikevents.js',
                    enabled: false,
                },
                {
                    name: 'tiktokEvents',
                    src: 'https://external.hillary.ua/gregorymill.com.ua/tiktokevents.js',
                    enabled: false,
                },
                {
                    name: 'marsyevent',
                    src: 'https://external.hillary.ua/gregorymill.com.ua/marsyevent.js',
                    enabled: true,
                },
                {
                    name: 'fontawesome',
                ...
                {
                    name: 'helpcrunch',
                    src: 'https://external.hillary.ua/gregorymill.com.ua/helpcrunch.js',
                    enabled: true,
                    before: () => {
                        window.helpcrunchSettings = {
                            organization: 'hillary',
                            appId: 'c96b5b86-3c9a-4bed-bdd5-79ccf6f38393',
                        };
                    },
                    after: () => {
    ...
    static installSystemsOnDOMContentLoaded() {
        document.addEventListener('DOMContentLoaded', async () => {
            ...
            if (Marsy.enableErrors) {
                ...
                Marsy.init()
                this.log({
                    message: `Systems installed in $ ms`,
                ...
                try {
                    ...
                    this.log({
                        message: `Failed to load some systems: $`,
            ...
            for (let system of marketing_systems.systems) {
                ...
                if (isEnabled) {
                    if (system.src.endsWith('.js')) {
                        ...
                        await Marsy.add_script(system, true); // Додаємо defer
