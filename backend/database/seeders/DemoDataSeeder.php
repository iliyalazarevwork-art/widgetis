    ...
    public function seedCustomerCases(Carbon $now): void
    {
        $cases = [
            ...
            [
                ...
                'color' => '#8b5cf6',
                'widgets' => [
                    ['name' => 'Безкоштовна доставка', 'slug' => 'free-delivery'],
                    ['name' => 'Хтось щойно купив', 'slug' => 'recent-purchase'],
                    ['name' => 'Прогресивна знижка', 'slug' => 'progressive-discount'],
                ],
                'sort_order' => 5,
            ],
            [
                ...
                'plan' => 'max',
                'review_rating' => 4.7,
                'result_metric' => '+12% повторних покупок',
                'result_period' => 'за 4 місяці',
                'color' => '#ec4899',
                'widgets' => [
                    ['name' => 'Дата доставки', 'slug' => 'delivery-date'],
                    ['name' => 'Квіз-рекомендатор', 'slug' => 'quiz'],
                    ['name' => 'Кешбек', 'slug' => 'cashback'],
                ],
                'sort_order' => 6,
            ],
        ];
