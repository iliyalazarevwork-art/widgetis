...
class DemoDataSeeder extends Seeder
{
    ...
    private function seedCustomerCases(Carbon $now): void
    {
        $cases = [
            [
                'store' => 'Kovalenko Outdoor',
                'store_url' => 'https://kovalenko-outdoor.com',
                'platform' => 'horoshop',
                'description' => [
                    'uk' => 'Після запуску Countdown Timer і Purchase Notification магазин отримав +14% до CR.',
                    'en' => 'After enabling Countdown Timer and Purchase Notification, the store reached +14% CR uplift.',
                ],
                'review_text' => 'Після інтеграції віджетів середній чек та частота повторних замовлень зросли.',
                'review_rating' => 5,
                'widgets' => ['countdown-timer', 'purchase-notification', 'delivery-date'],
                'sort_order' => 1,
            ],
            [
                'store' => 'Mori Kids',
                'store_url' => 'https://mori-kids.com',
                'platform' => 'horoshop',
                'description' => [
                    'uk' => 'Marquee та Free Shipping Bar дали більше переходів у кошик у вечірній трафік.',
                    'en' => 'Marquee and Free Shipping Bar improved add-to-cart rate during evening traffic.',
                ],
                'review_text' => 'За перший місяць отримали помітний приріст конверсії на мобільному.',
                'review_rating' => 5,
                'widgets' => ['marquee', 'free-shipping-bar'],
                'sort_order' => 2,
            ],
            [
                'store' => 'Urban Craft UA',
                'store_url' => 'https://urban-craft-ua.com',
                'platform' => 'shopify',
                'description' => [
                    'uk' => 'Delivery Date зменшив кількість питань у чаті щодо строків доставки.',
                    'en' => 'Delivery Date reduced support questions about shipping timelines.',
                ],
                'review_text' => 'Клієнти бачать дату доставки ще до оформлення, стало менше кинутих кошиків.',
                'review_rating' => 4,
                'widgets' => ['delivery-date', 'visitor-counter'],
                'sort_order' => 3,
            ],
        ];
