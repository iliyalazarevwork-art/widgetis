...
use App\Core\Http\Requests\Api\V1\Public\GuestCheckoutRequest;
...
class GuestCheckoutController
{
    ...
    public function __invoke(GuestCheckoutRequest $request): JsonResponse
    {
        ...
        $plan          = \App\Core\Models\Plan::where('slug', $validated['plan_slug'])->where('is_active', true)->firstOrFail();
