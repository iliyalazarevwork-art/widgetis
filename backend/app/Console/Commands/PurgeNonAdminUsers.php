...
class PurgeNonAdminUsers extends Command
{
    ...
    public function handle(): int
    {
        ...
        DB::transaction(function () use ($ids): void {
            ...
            $siteIds = DB::table('wgt_sites')->whereIn('user_id', $ids)->pluck('id');

            DB::table('wgt_site_widgets')->whereIn('site_id', $siteIds)->delete();
            DB::table('wgt_site_scripts')->whereIn('site_id', $siteIds)->delete();
            ...
            DB::table('wgt_reviews')->whereIn('user_id', $ids)->delete();
            ...
            DB::table('wgt_demo_sessions')->whereIn('created_by', $ids)->delete();
            DB::table('wgt_user_widget_grants')->whereIn('user_id', $ids)->delete();
            DB::table('activity_log')->whereIn('user_id', $ids)->delete();
            DB::table('sessions')->whereIn('user_id', $ids)->delete();

            DB::table('wgt_sites')->whereIn('user_id', $ids)->delete();
