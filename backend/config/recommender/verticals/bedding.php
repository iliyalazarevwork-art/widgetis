...
return [
    ...
    'complement_rules' => [
        ...
        'duvet_cover' => ['fitted_sheet', 'flat_sheet', 'pillowcase', 'duvet_insert', 'throw_blanket', 'bedspread'],
        'fitted_sheet' => ['duvet_cover', 'pillowcase', 'bedspread', 'throw_blanket', 'cushion'],
        'flat_sheet' => ['duvet_cover', 'pillowcase', 'bedspread', 'throw_blanket', 'cushion'],
        'pillowcase' => ['fitted_sheet', 'flat_sheet', 'duvet_cover', 'bedspread', 'throw_blanket', 'cushion'],
        'pillow' => ['pillowcase', 'duvet_cover', 'bedspread', 'throw_blanket'],
        'duvet_insert' => ['duvet_cover', 'fitted_sheet', 'pillowcase', 'bedspread'],
        'blanket' => ['pillowcase', 'fitted_sheet', 'bedspread', 'cushion'],
        'throw_blanket' => ['pillowcase', 'fitted_sheet', 'bedspread', 'cushion'],
        'bedspread' => ['pillowcase', 'fitted_sheet', 'duvet_cover', 'throw_blanket', 'cushion'],
        'mattress_topper' => ['fitted_sheet', 'mattress_protector', 'pillow'],
        'mattress_protector' => ['fitted_sheet', 'mattress_topper', 'pillow'],
        'cushion' => ['cushion_cover', 'throw_blanket', 'bedspread', 'pillowcase'],
        'cushion_cover' => ['cushion', 'throw_blanket', 'bedspread', 'pillowcase'],
        'bathrobe' => ['towel', 'bath_set'],
        'towel' => ['bathrobe', 'bath_set', 'home_decor'],
        'bath_set' => ['towel', 'bathrobe', 'home_decor'],
        'curtain' => ['bedspread', 'cushion', 'home_decor'],
        'home_decor' => ['cushion', 'throw_blanket', 'curtain'],
    ],
];
