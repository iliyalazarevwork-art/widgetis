...
const ITEMS = [
  {
    q: 'Чи працює з моєю CMS?',
    a: 'Так. Віджети сумісні з Shopify, WooCommerce, Prom, Хорошоп, OpenCart та будь-яким сайтом, куди можна вставити HTML-код. Якщо не впевнений — напиши, перевіримо за 5 хвилин.',
  },
  {
