...
Це стандартна практика для українських та міжнародних SaaS-сервісів (Хорошоп, Serpstat, Binotel тощо).`,
  },
  {
...
— розірвання з причин форс-мажору (в тому числі призупинення роботи платформи Хорошоп).`,
  },
]
