...
export function DemoPage() {
  ...
  return (
    <div className="demo-page">
      <SeoHead
        title={`Демо віджетів для Хорошоп — ${BRAND_NAME_UPPER} | Спробуй на своєму сайті`}
        description={`Подивіться, як виглядають маркетингові віджети на Вашому магазині Хорошоп. Безкоштовне живе демо за 10 секунд — без реєстрації та оплати.`}
        keywords="демо віджетів Хорошоп, демо Horoshop, перевірити плагін Хорошоп, тест маркетингових інструментів Хорошоп, horoshop demo"
        path="/demo"
      />
