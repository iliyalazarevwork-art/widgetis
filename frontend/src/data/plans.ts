...
export const PLANS: PlanDef[] = [
  {
    ...
    widgetSlugs: ['delivery-date', 'marquee', 'sticky-buy-button', 'trust-badges'],
  },
  {
    id: 'pro',
    name: 'Pro',
    ...
    features: [
      ...
      { label: 'Лічильник покупок', slug: 'social-proof' },
      { label: 'Фотовідгуки', slug: 'photo-reviews' },
      { label: '3 сайти' },
      { label: 'Self-service кастомізація' },
    ],
    widgetSlugs: [
      'delivery-date', 'marquee', 'sticky-buy-button', 'trust-badges',
      'cart-goal', 'social-proof', 'stock-left', 'photo-reviews',
    ],
  },
  {
    id: 'max',
    ...
    widgetSlugs: [
      'delivery-date', 'marquee', 'sticky-buy-button', 'trust-badges',
      'cart-goal', 'social-proof', 'stock-left', 'photo-reviews',
      'recently-viewed', 'product-video-preview', 'floating-messengers', 'cart-recommender',
      'progressive-discount', 'one-plus-one', 'exit-intent-popup', 'spin-the-wheel',
      'sms-otp-checkout',
    ],
  },
]
